...
class ModelArguments:
	...
	resume_training: bool = field(
        default=False,
        metadata={
                "help": "If true, the model will be loaded from the latest checkpoint."
            },
    )
...
def main():
	...
	print(f"Dataset path: {data_args.train_file}")
	print(f"Checkpoints path: {model_args.model_name_or_path}")
	print(f"Output path: {training_args.output_dir}")
	print("====================================")
	...
	# Set the name of input/target columns
