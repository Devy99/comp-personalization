...
if __name__ == '__main__':
	...
	for dev_id in devs_ids:
		...
		base_cb_df, dev_cb_df, org_cb_df = dev_cb_dict['pt-sft1'], dev_cb_dict['sft1-sft2-dev'], dev_cb_dict['sft1-sft2-all-dev']
		em_base, em_dev, em_org = base_cb_df['correct'].tolist(), dev_cb_df['correct'].tolist(), org_cb_df['correct'].tolist()
	...
	mean_df.to_csv(os.path.join(results_dir, 'crystalbleu_top_100_small.csv'), index=False)
