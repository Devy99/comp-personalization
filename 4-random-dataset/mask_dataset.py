...
def extra_columns(dataframe: pd.DataFrame):
    header = ['author', 'repository', 'commit_id', 'date', 'filepath', 'type', 'added_line']
    columns = [dataframe['author'].tolist(), dataframe['repository'].tolist(), dataframe['commit_id'].tolist(), dataframe['date'].tolist(), dataframe['filepath'].tolist(), dataframe['type'].tolist(), dataframe['added_line'].tolist()]
